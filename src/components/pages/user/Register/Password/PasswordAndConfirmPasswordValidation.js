...
useEffect(() => {
    if(!passwordError && !confirmPasswordError && !formErr && passwordInput.confirmPassword.length>0) {
      setPasswordCorrect(true)
    } else {
      setPasswordCorrect(false)
    }
},[passwordError, confirmPasswordError, formErr, passwordInput.confirmPassword.length])
